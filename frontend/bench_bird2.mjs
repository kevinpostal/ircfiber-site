...
import { renderPixelsCore, clearColorLut, smartPaletteA, smartPaletteB } from './src/lib/img2irc.ts';
...
async function bench(){
  ...
  console.log(`Image ${img.width}x${img.height} -> bench widths 80/120 half mode`);
  const configs=[];
